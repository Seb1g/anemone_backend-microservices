...
func (r *BoardRepo) CreateBoard(ctx context.Context, title string, userID int64) (*trello_model.Board, error) {
...
func (r *BoardRepo) GetAllUserBoards(ctx context.Context, userID int64) ([]*trello_model.Board, error) {
...
func (r *BoardRepo) UpdateBoard(ctx context.Context, boardID string, userID int64, boardData []*trello_model.Column) (err error) {
	tx, err := r.DB.BeginTxx(ctx, nil)
	if err != nil {
...
func (r *BoardRepo) GetBoardOwnerID(ctx context.Context, boardID string) (int64, error) {
	var ownerID int64
...
func (r *BoardRepo) GetBoardOwnerIDByColumnID(ctx context.Context, columnID string) (int64, error) {
	var ownerID int64
	query := `
        SELECT b.user_id 
        FROM boards b 
